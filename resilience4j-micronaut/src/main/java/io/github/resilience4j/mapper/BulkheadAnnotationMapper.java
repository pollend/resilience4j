 ...
 */
public final class BulkheadAnnotationMapper implements TypedAnnotationMapper<Bulkhead> {
    ...
    public List<AnnotationValue<?>> map(AnnotationValue<Bulkhead> annotation, VisitorContext visitorContext) {
        ...
        final AnnotationValueBuilder<Type> typeBuilder = AnnotationValue.builder(Type.class).member("value", BulkheadInterceptor.class, ThreadPoolBulkheadInterceptor.class);
